  ...
  Map<String, Map<String, String>> get keys {
    return {
      "en_US": {
        ...
        "cardnumberlengthvalidate": "OCWC number must 11 digits.",
        "numbercardhint": "Enter a card number 11 digits",
        "help": "Help?",
        ...
        'start': "Start",
        'to': "To",
        'agencyperpage': "Agency Per Page",
        'page': "Page",
        'cardnumvalidation':
            "OCWC number must start with GOV, BTB, BMC, or MOU.",
        'findrecruiter': "Find Recruiter Information",
        'inputrecruiter': "Enter Recruiter Name",
        'scanrecruiter': "Scan Recruiter Card",
        'recruitertitle': "Enter Latin or Khmer name",
      },
      "km_KH": {
        ...
        "cardnumberlengthvalidate": "លេខ OCWC ត្រូវតែមានចំនួន 11 ខ្ទង",
        "numbercardhint": "បញ្ចូលលេខបណ្ណ​ 11 ខ្ទង់",
        "help": "ជំនួយ ?",
        ...
        'or': "ឬ",
        'agencylist': "បង្ហាញបញ្ជីឈ្មោះទីភ្នាក់ងារជ្រើសរើសឯកជនទាំងអស់",
        'searchagency': "បញ្ចូនឈ្មោះទីភ្នាក់ងារជ្រើសរើសឯកជន",
        'start': "ចាប់ផ្តើម",
        'to': "ដល់",
        'agencyperpage': "ចំនួនភ្នាក់ងារក្នុងមួយទំព័រ",
        'page': "ទំព័រ",
        'cardnumvalidation': "លេខ OCWC ត្រូវចាប់ផ្តើមដោយ GOV, BTB, BMC, ឬ MOU។",
        'findrecruiter': "ស្វែងរកព័ត៌មានភ្នាក់ងារ",
        'inputrecruiter': "បញ្ចូលឈ្មោះភ្នាក់ងារ",
        'scanrecruiter': "ស្កេនបណ្ណភ្នាក់ងារ",
        'recruitertitle': "បញ្ចូលឈ្មោះភ្នាក់ងារជាអក្សរឡាតាំង ឬអក្សរខ្មែរ",
      }
    };
  }
}
