...
class WebNewScreen extends StatelessWidget {
  ...
  Widget _buildBody() {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (constraints.maxWidth > 1300) {
        return SingleChildScrollView(child: webUIScreen(context, constraints));
      } else {
        return SingleChildScrollView(child: phoneUIScreen(context));
      }
    });
  }
  ...
  Widget webUIScreen(BuildContext context, BoxConstraints boxConstraints) {
          ...
          CustomCard(
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  itemCount:
                      (controller.workerData!.tricking.length / 2).ceil(),
                  itemBuilder: (BuildContext context, int index) {
                    var track = controller.workerData!.tricking[index * 2];
                    var track2 = controller.workerData!.tricking[index * 2 + 1];
                    Color? textColor = Colors.green;
                    Color? textColor2 = Colors.green;
                    int falseIndex = controller.workerData!.tricking.indexWhere(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    CustomText(
                      homeController: homeController,
                      title: "issuseDate".tr,
                      data: controller.workerData!.issuedDate.enIssuedDate ??
                          "noData".tr,
                    ),
                    CustomText(
                        title: 'expireDate'.tr,
                        data:
                            controller.workerData!.expiredDate.enExpiresDate ??
                                "noData".tr,
                        homeController: homeController),
                  ].withSpaceBetween(height: 10)),
                ),
  ...
  Widget phoneUIScreen(BuildContext context) {
    var contanstraintWidth = 600.0;
    return Center(
      child: Padding(
                  ...
                  child: Column(
                    ...
                    CustomText(
                        ...
                        dataStyle: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize:
                                homeController.langCode.value == "en" ? 16 : 16,
                            fontFamily: "Battambang"),
                  ...
                  SizedBox(
                    ...
                    child: Column(children: [
                      ...
                      CustomText(
                          ...
                          title: "issuseDate".tr,
                          data:
                              controller.workerData!.issuedDate.enIssuedDate ??
                                  "noData".tr,
                          homeController: homeController),
                      CustomText(
                          alignmentTile: Alignment.bottomRight,
                          title: 'expireDate'.tr,
                          data: controller
                                  .workerData!.expiredDate.enExpiresDate ??
                              "noData".tr,
                          homeController: homeController),
                      const SizedBox(height: 20),
                    ]),
